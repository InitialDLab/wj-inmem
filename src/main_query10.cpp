...
void test_dynamic(date_t &cond_date1, date_t &cond_date2){
	...
	}
	{
		...
		index_ripple_query10(p1->data, p2->data, p3->data, nullptr, nullptr, nullptr, key_func, result_func, step_time, max_time, .95, value*0.01, true);
	}
	...
	for(size_t n = 0; n < 1; ++n)
	{
		...
		for(size_t r = 0; r < order_list.size(); ++r){
			...
			result[r] = query.run_time_limit(1000000*20, step_time);
