...
void test_dynamic(date_t &cond_date1, date_t &cond_date2){
	...
	}
	{
		...
		date_t cond_date{1992,1,1};
		index_ripple_query3(p0->data, p1->data, p2->data, result_func, nullptr, &cond_date, &cond_date1, nullptr, nullptr, key_func, step_time, max_time, .95, value*0.01, true);
	}
