...
void test_dynamic(date_t &cond_date1, date_t &cond_date2){
	...
	}
	{
		...
		ripple_3_ratio_test(table, a, key_func, cond_func, result_func, step_time, max_time, .95, true, total_size);
		index_ripple_query3(p0->data, p1->data, p2->data, result_func, nullptr, nullptr, nullptr, nullptr, nullptr,
				key_func, step_time, max_time, .95, value*0.01, true);
	}
	return;
...
int main(int argc, char *argv[]){
	std::vector<date_t> cond_date{{1999,12,1}};
